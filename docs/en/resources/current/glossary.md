...
<p><em>Ex.</em> “The provided values contain <strong>unstructured</strong> information of the appellation, such as there is no systematic and automatic way to recognise the different part of an appellation or it cannot be parsed automatically by reconciliation tools, but still contains the required information” (<a href="https://chin-rcip.github.io/collections-model/en/semantic-paths-specification/current/entry-nodes#actor-appellation">Semantic Paths Specification 2020</a>).</p></td>
...
<p><em>Note.</em> Dans le contexte de la spécification du RCIP, le terme “le modèle” est parfois utilisé à des fins de concision pour référer au “Modèle de données du RCIP”.</p>
<br>
