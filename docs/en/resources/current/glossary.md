...
<tr class="odd">
<td class="first-lang"><h3 id="reconciliation-noun">reconciliation (noun)</h3>
<p><em>Def</em>. Process by which, during data migration and using a series of validation elements, target data is compared to source data to ensure they were merged and transformed correctly into a format that is suitable for use in the destination database or system. </p>
...
<tr class="odd">
<td class="first-lang"><h3 id="reification-noun">reification (noun)</h3>
...
<tr class="even">
<td class="first-lang"><h3 id="slug-noun">slug (noun)</h3>
...
<td class="second-lang"><h3>identifiant pour adresse URL (nom masculin)</h3>
