...
language: en
title: Bibliography
permalink: /en/target-model/version-2-1/bibliography
...
> Previous: [Legal Aspects (Rights)](/collections-model/en/target-model/version-2-1/legal-aspects-rights)<br>Next: [Appendix A](/collections-model/en/target-model/version-2-1/appendix-a-data-provenance)