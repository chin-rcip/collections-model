...
This document is based on the Artefact Semantic Reference Data Model by George Bruseker and follows a similar structure [(Bruseker 2019)](/collections-model/en/target-model/current/bibliography#bruseker-2019). This work is also indebted to the [linked.art](https://linked.art/) project whose scope differs from that of CHIN’s, but whose review and discussions of issues are beneficial [(linked.art 2019a)](/collections-model/en/target-model/current/bibliography#linked-art-2019a).
